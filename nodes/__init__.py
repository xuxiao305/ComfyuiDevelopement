...
from .sam3_unified import NODE_CLASS_MAPPINGS as UNIFIED_MAPPINGS
from .sam3_unified import NODE_DISPLAY_NAME_MAPPINGS as UNIFIED_DISPLAY_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(UNIFIED_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(UNIFIED_DISPLAY_MAPPINGS)
